...
<style><%@include file="/styles/paymentdeleteTemp2.css"%></style>
...
<!--Navigation Content-->
    <nav>
		...
		<h1 style="color: white; text-align: center">Delete Section</h1><br>
    <div class="payment">
    ...
    <label>PaymentId :</label><br>
       ...
       <input class="InputofData" type="number" name="Cnumber" value="<%=Cnumber%>" readonly><br>
       
       <label>Name :</label><br>
       <input type="text" name="name" value="<%=name%>" readonly><br>
       
       <label>Card Type :</label><br>
       <input type="text" name="Ctype" value="<%=Ctype%>" readonly><br>

       <label>Address :</label><br>
       <input type="text" name="address" value="<%=address%>" readonly><br>

       <label>Country :</label><br>
       <input type="text" name="Country" value="<%=country%>" readonly><br>

        <button type="submit" name="pass" >Delete Section</button>
    </form>
